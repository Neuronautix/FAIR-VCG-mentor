...
function getExports(id: string): ExportItem[] {
  return [
    ...
    {
      label: 'ARRIVE 2.0 Reporting Completeness Report',
      description: 'Reporting completeness assessment — not regulatory validation. Which ARRIVE 2.0 fields are satisfied.',
      url: arriveReportUrl,
    ...
    {
      label: 'PREPARE Study Planning Readiness Report',
      description: 'Study planning readiness assessment — not regulatory validation. Which PREPARE checklist items are addressed.',
